...
conn.connect(function (err) {
  ...
  conn.query(
      "SELECT user.UserName, user.Status, vehicle.VehicleName, states.StateName, vehicleregistration.RegistrationDate, vehicleregistration.ExpiryDate from vehicle JOIN vehicleregistration ON vehicle.VehicleID = vehicleregistration.VehicleID JOIN user ON user.UserID = vehicleregistration.UserID JOIN states ON states.StateID = user.StateID where user.Status = 'True' order by user.UserID",
