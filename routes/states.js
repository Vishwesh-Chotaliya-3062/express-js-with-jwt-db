...
const ascendingStateNames = ascendingStates.filter(x => x.StateName).map(x => ["ID: " + x.ID, "State Name: " + x.StateName]);
...
module.exports = {states,ascendingStateNames,stateNamesIn2020,idByID,reverseName};